...
const reviews_data = [
  {
    ...
    name: "Liam Smith",
    comment:
      "What's better than indulging in candies and winning big?  Olympus  is my go-to for the sweetest victories!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Olivia Tremblay",
    comment:
      "Been playing  Olympus  for weeks now — it's simply captivating! Consistent wins and loads of free spins. Absolutely adore this slot!",
  },
  {
  ...
  },
  {
    ...
    name: "Emma Gagnon",
    comment:
      " Olympus  is a treat for the eyes and the wallet! Loving the constant thrill of tumbling wins and the free spins galore.",
  },
  {
