...
const reviews_data = [
  {
    ...
    name: "Pierre Dubois",
    comment:
      "Sweet Bonanza est une évasion sucrée de la réalité ! Les jeux sont amusants et addictifs, et les bonus me font revenir encore et encore. 5/5 !",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Antoine Lefevre",
    comment:
      "En tant qu'amateur de casino en France, je peux dire que Sweet Bonanza est l'une des applications les plus agréables que j'ai essayées. Les graphismes sont de premier ordre et le gameplay est fluide. 4.5/5 !",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Élodie Martin",
    comment:
      "Sweet Bonanza est mon petit plaisir coupable ! Les jeux à thème bonbon sont adorables et les bonus sont sucrés aussi. 4.5/5 !",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Jean-Marie Petit",
    comment:
      "J'adore Sweet Bonanza ! Les machines à sous à thème bonbon sont tellement amusantes à jouer, et les tours bonus sont passionnants. Ça vaut vraiment le coup d'œil. 5/5 !",
  },

  {
    ...
    name: "Camille Dupont",
    comment:
      "Je ne peux pas me passer de Sweet Bonanza ! Les graphismes sont ravissants et le gameplay est addictif. Je recommande vivement à quiconque cherche une expérience de casino amusante. 5/5 !",
  },
];
